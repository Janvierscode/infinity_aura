...
export default async function IdeaPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article className="idea-page">
      ...
      <section className="container idea-body public-idea-preview"><span className="section-label">Idea preview</span><MarkdownContent markdown={idea.preview_markdown} /></section>
